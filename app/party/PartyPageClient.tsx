      ...
      <div className="container-game safe-area-top safe-area-bottom">
        ...
        >
          ...
          <p className="text-secondary text-lg">
            Group games and drinking challenges
          </p>
        </motion.div>
        ...
        >
          <Link href="/party/intensity">
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-primary mb-3 group-hover:accent-party transition-colors">
                Start Your Party
              </h2>
              <p className="text-secondary">
                Choose your intensity and begin the fun
              </p>
            </motion.div>
          </Link>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { emoji: "🍻", title: "Drinking Games", desc: "Classic party challenges" },
              { emoji: "🎭", title: "Charades", desc: "Act it out!" },
              { emoji: "🍾", title: "Spin the Bottle", desc: "Classic party game" },
              { emoji: "👑", title: "King's Cup", desc: "Card drinking game" }
            ].map((game, index) => (
              <motion.div
                key={game.title}
